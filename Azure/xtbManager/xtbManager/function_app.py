...
@app.blob_trigger(arg_name="myblob", path="xtbraports",
                               connection="xtbraports_STORAGE") 
def GetRaport(myblob: func.InputStream):
...
# @app.blob_trigger(arg_name="client", path="xtbraports",
#                   connection="xtbraports_STORAGE")
# def GetRaport(client: blob.BlobClient):
#     logging.info(
